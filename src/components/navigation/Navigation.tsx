...
const Navigation: React.FC = () => {
    ...
    const menuItems = () => {
        return (
            <>
                {items?.map((item: MenuItem, index: any) => {
                    const classList = [
                        'menu__item',
                                    ...
                                    {item.children.map((child, i) => {
                                        return (
                                            <li key={i} className="dropdown__item">
                                                <a
                                                    onClick={() => {
                                                        openSubLink(child.link);
                                                    }}
                                                >
                                                    <i className="menu__icon material-icons">
